...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Jupiter_MiSTer.git"
CORE_NAME=(Jupiter)
...
UPSTREAM_CORE_NAME=(Jupiter)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Jupiter.qpf)
COMPILATION_OUTPUT=(output_files/Jupiter.rbf)
